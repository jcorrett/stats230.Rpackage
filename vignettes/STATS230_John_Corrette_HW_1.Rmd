...
The package data is stored under the folder named mainProject, to compile and install the library, load mainProject, and use the package devtools to build and install, and the package should be installed under the name stats230.Rpackage.
